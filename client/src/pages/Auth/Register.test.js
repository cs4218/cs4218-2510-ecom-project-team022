...
describe('Register Component', () => {
  ...
  it('should display error message on API rejection', async () => {
  ...
  it('should not allow form submission if not all fields are filled', async () => {
  ...
  // todo(marcus): it should not allow registration if one or more fields are missing
  // todo(marcus): it should display the error message from backend if registration fails due to validation error
  // the above test is a bug
