...
describe("createProductController, updateProductController, deleteProductController", () => {
  test("successfully create product", async () => {
    ...
    expect(res.body).toHaveProperty(
      "message",
      productControllers.successMessages.CREATE_PRODUCT
    );
    expect(res.body.product).toHaveProperty("name", "ProductA");
  ...
  test("successfully update product", async () => {
    ...
    expect(res.body).toHaveProperty(
      "message",
      productControllers.successMessages.UPDATE_PRODUCT
    );
  ...
  test("successfully delete product", async () => {
    ...
    expect(res.body).toHaveProperty(
      "message",
      productControllers.successMessages.DELETE_PRODUCT
    );
